	...
	<style>
		...
		.content .side{ width: calc(30%); padding: 1em; background-color: #C7C7C7; }

		.trabajo .fecha{ text-align: left; margin-bottom: 0.2em; font-style: italic;}
		.trabajo .puesto{ font-variant: small-caps; font-weight: normal; padding-left: 50px; }
		.trabajo .empresa{ font-size: 1em;  padding-left: 5em;}
		...
		.escuela .titulo{ font-variant: small-caps; font-weight: normal; font-size: 1.3em; padding-left: 50px; }
